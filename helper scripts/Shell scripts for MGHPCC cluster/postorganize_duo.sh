read -p "prefix: (obj1 idx1 obj2 idx2): " obj1 idx1 obj2 idx2
read -p "postfix (_xxx): " postfix

prefix=""$obj1""$idx1"-"$obj2""$idx2""
...
cd ./1/cartHeat/
zip -r "$tbudir1"/"$prefix"_cam1_1-500"$postfix".zip ./"$prefix"_cam1_1-500"$postfix"
zip -r "$tbudir1"/"$prefix"_cam2_1-500"$postfix".zip ./"$prefix"_cam2_1-500"$postfix"
zip -r "$tbudir1"/"$prefix"_cam3_1-500"$postfix".zip ./"$prefix"_cam3_1-500"$postfix"
zip -r "$tbudir1"/"$prefix"_cam4_1-500"$postfix".zip ./"$prefix"_cam4_1-500"$postfix"

cd ../../2/cartHeat/
zip -r "$tbudir2"/"$prefix"_cam1_501-1000"$postfix".zip ./"$prefix"_cam1_501-1000"$postfix"
zip -r "$tbudir2"/"$prefix"_cam2_501-1000"$postfix".zip ./"$prefix"_cam2_501-1000"$postfix"
zip -r "$tbudir2"/"$prefix"_cam3_501-1000"$postfix".zip ./"$prefix"_cam3_501-1000"$postfix"
zip -r "$tbudir2"/"$prefix"_cam4_501-1000"$postfix".zip ./"$prefix"_cam4_501-1000"$postfix"

cd ../../3/cartHeat/
zip -r "$tbudir3"/"$prefix"_cam1_1001-1500"$postfix".zip ./"$prefix"_cam1_1001-1500"$postfix"
zip -r "$tbudir3"/"$prefix"_cam2_1001-1500"$postfix".zip ./"$prefix"_cam2_1001-1500"$postfix"
zip -r "$tbudir3"/"$prefix"_cam3_1001-1500"$postfix".zip ./"$prefix"_cam3_1001-1500"$postfix"
zip -r "$tbudir3"/"$prefix"_cam4_1001-1500"$postfix".zip ./"$prefix"_cam4_1001-1500"$postfix"

cd ../../4/cartHeat/
zip -r "$tbudir4"/"$prefix"_cam1_1501-2000"$postfix".zip ./"$prefix"_cam1_1501-2000"$postfix"
zip -r "$tbudir4"/"$prefix"_cam2_1501-2000"$postfix".zip ./"$prefix"_cam2_1501-2000"$postfix"
zip -r "$tbudir4"/"$prefix"_cam3_1501-2000"$postfix".zip ./"$prefix"_cam3_1501-2000"$postfix"
zip -r "$tbudir4"/"$prefix"_cam4_1501-2000"$postfix".zip ./"$prefix"_cam4_1501-2000"$postfix"

cd ../../5/cartHeat/
zip -r "$tbudir5"/"$prefix"_cam1_2001-2500"$postfix".zip ./"$prefix"_cam1_2001-2500"$postfix"
zip -r "$tbudir5"/"$prefix"_cam2_2001-2500"$postfix".zip ./"$prefix"_cam2_2001-2500"$postfix"
zip -r "$tbudir5"/"$prefix"_cam3_2001-2500"$postfix".zip ./"$prefix"_cam3_2001-2500"$postfix"
zip -r "$tbudir5"/"$prefix"_cam4_2001-2500"$postfix".zip ./"$prefix"_cam4_2001-2500"$postfix"
