# ver.2 no renaming before zipping
...
#mv ./1/label ./1/"$prefix"_label_1-500"$postfix"
...
#mv ./2/label ./2/"$prefix"_label_501-1000"$postfix"
...
#mv ./3/label ./3/"$prefix"_label_1001-1500"$postfix"
...
#mv ./4/label ./4/"$prefix"_label_1501-2000"$postfix"
...
#mv ./5/label ./5/"$prefix"_label_2001-2500"$postfix"
