...
CAD1_idx = 1; CAD2_idx = 4;
str_idx = 1; stp_idx = 1;
plc_range = str_idx:stp_idx;

scene_sz = [6,6,2]; % [WxLxH] in [x,y,z]

xlb = "x(m)"; ylb = "y(m)"; zlb = "z(m)";
vis = "on";
addr0 = strcat("..",SLASH,"results",SLASH,obj1_name,num2str(CAD1_idx),'-',...
    obj2_name,num2str(CAD2_idx));   
for vib = 0:1
    if vib == 0
...
%}
            ...
            prefix = strcat(obj1_name,num2str(CAD1_idx),"-",obj2_name,num2str(CAD2_idx)...
                ,"_idx",num2str(plc_idx),"_cam",num2str(cam),"_",vib_postfix,"_");
