%%% 03/03/2022: Combine two CAD models
...
function main_duo(obj1_name, CAD1_idx, obj2_name, CAD2_idx, start_idx, stop_idx)
    ...
    logging_duo(logFile, obj1_name, CAD1_idx, obj2_name, CAD2_idx, N_RX_az, N_RX_el, atn_bdl,...
    ...
    for kso = start_idx:stop_idx
        ...
        for cs = 1:4
            ...
            disp(strcat(obj1_name,"<",num2str(CAD1_idx),"> & ",obj2_name,...
                "<", num2str(CAD2_idx),">, placement<", num2str(ks),...
                ">, view<", num2str(view_idx),">"));
            ...
            Imglabels = labelImg_duo(visible_cad1, visible_cad2);
            ...
            %rftaddr = strcat(result_addr);
            %save(strcat(rftaddr,SLASH,"cam",num2str(view_idx),"_plc",num2str(ks),"_RadarReflectorNoisy.mat"),'reflector_cart_v_noisy');
