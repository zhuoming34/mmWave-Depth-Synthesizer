function logging_trio(logFile, obj1_name, CAD1_idx, obj2_name, CAD2_idx, ...
    ...
    fID = fopen(logFile,'w');
    fprintf(fID,strcat("\n\t( ◞•̀w•́)◞\t",obj1_name," #%d - ",obj2_name," #%d - ",...
        obj3_name," #%d","\t◟(•̀w•́◟ )\n\n"), CAD1_idx, CAD2_idx, CAD3_idx);
    ...
    fprintf(fID,strcat("> Object 3 placement region [m] \t(w/ respect to sensor #1)\n",...
        "\tx from\t%.3f\tto\t%.3f\n\ty from\t%.3f\tto\t%.3f\n\n"),translate_lim_3'/1000);
