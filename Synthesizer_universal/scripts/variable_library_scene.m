...
% sensor positions
sensor_x = [0,7500,0,-7500]; % mm
sensor_y = [0,7500,15000,7500]; % mm
...
translate_lim_1 = [-3000, -1000; 8500, 10500]; % for 1st CAD
translate_lim_2 = [-1000, 3000; 5500, 9500]; % for 2nd CAD
translate_lim_3 = [-2500, -1000; 4500, 6000]; % for 3nd CAD
...
heatmap_ceiling = 1000; %mm
% [x1,x2; y1,y2; z1,z2]
scene_lim_edge = [-3000, 3000; 4500, 10500; -height_offset, heatmap_ceiling];          
