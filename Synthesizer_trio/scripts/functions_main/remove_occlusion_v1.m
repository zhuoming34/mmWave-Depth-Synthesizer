function [visible_cart_v] = remove_occlusion_v1(car_scene_v, device, filter2nd)
...
% Output: 'visible_cart_v' point cloud of the visible body car to the radar (catesian coordinates)
    ...
    % define voxel size of the grid
        phi_res = 0.05/180*pi;%0.02/180*pi;
        theta_res = 0.05/180*pi;%0.02/180*pi;
        rho_res = 0.025; %0.01;
    end
    if device == "rad"
        phi_res = 0.2/180*pi;%0.2/180*pi;
        theta_res = 0.5/180*pi;%0.5/180*pi;
        rho_res = 0.02;%0.02;
    end
