function radar_heatmap = radar_dsp2ss(signal_array)
...
% Output: "radar_heatmap" 3D radar heatmap in the spherical coordinates [rho, phi, theta]
    ...
    range_FFT_array = fft(signal_array,N_FFT,1).*repmat(range_bin.',[1,array_size2(1),array_size2(2)]); % range FFT
    ...
    x_idx = reshape(array_x_idx2,1,[]);
    z_idx = reshape(array_z_idx2,1,1,[]);
